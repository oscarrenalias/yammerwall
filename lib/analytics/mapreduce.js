...
module.exports.start = function() {
	...
	var topTopics = MapReduceJob("top_topics", require("./mapreduce.top_users.js"), every1Minute)
	var topThreads = MapReduceJob("top_threads", require("./mapreduce.top_users.js"), every1Minute)
	var topClients = MapReduceJob("top_clients", require("./mapreduce.top_users.js"), every1Minute)
}